		...
		<table class="table table-bordered">
			<form method='post'>
				<tr>
					...
					<div class="col-4">
						<td><input class="form-control" type='text' name='name' id='name' placeholder="${vaccine}" required></td>
					</div>
				</tr>
				
				<tr>
					<th><label for='dosage'>Doses Required</label></th>
				...
				<tr>
				<th><label for='between'>Days Between Doses</label></th>
					<td><input type='text' name='between' id='between' required>
				</td>
				</tr>
		
				<tr>
					<td colspan='2'>
					<a href="ListVaccines" class="btn btn-primary mr-3">Back</a>
					<button class="btn btn-primary">Save</button>
					<input type='hidden' name='id' value="${myVaccine.id}">
					</td>
				</tr>
			</form>
		</table>
